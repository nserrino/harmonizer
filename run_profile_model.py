...
from profiling.profile_model import get_training_set_distribution, get_lstm_result_distribution, get_hmm_result_distribution
...
print "input song distribution:", get_training_set_distribution(training_resamples)
...
if args.model.endswith('lstm.h5'):
    ...
    print get_hmm_result_distribution(outputs)
else:
